...
#
# The public checkpoint release (Zenodo / Hugging Face) is being
# prepared; until the URL lands here, this script documents the
# expected layout. To test the eval pipeline before the release,
# train PPLC yourself with
